...
public class Board extends JPanel implements ActionListener {
    ...
    private final int ALL_DOTS = 1296;
    private final int RAND_POS = 35;
    public int DELAY = 220;
    ...
    private void doDrawing(Graphics g) {
        ...
        if (inGame) {
            ...
            int curscore = (dots-3)*10;
            String scoremsg = "\nYour Score: "+ Integer.toString(curscore);
            Font small = new Font("Verdana", ~Font.BOLD, 13);

            g.setColor(Color.white);
            g.setFont(small);
            g.drawString(scoremsg, 230, 16);
